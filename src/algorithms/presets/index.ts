...
export type SamplePresetId = 'natural_beauty' | 'clean_beauty' | 'lite_beauty' | 'debug_warp_strong' | 'debug_warp_strong_bypass' | 'soft_beauty' | 'strong_beauty' | 'face_slim' | 'skin_tone';
...
export const samplePresets: Record<SamplePresetId, { id: SamplePresetId; label: string; preset: WarpPreset }> = {
  ...
  debug_warp_strong_bypass: { id: 'debug_warp_strong_bypass', label: 'デバッグ強変形(BYPASS)', preset: debugWarpStrongPreset },
